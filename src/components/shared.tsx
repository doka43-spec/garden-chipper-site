...
export const PARTS = [
  ...
  { name: "Ножи рубительные сменные для арболитного щепореза (30 кВт, 37 кВт, 45 кВт)", material: "Сменные ножи для щепореза", price: "3 500 ₽ за 1 шт.", priceValue: 3500, icon: "Wrench", images: [] },
];
