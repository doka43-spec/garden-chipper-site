  ...
  return (
    <>
      ...
      <section id="home" className="relative min-h-[92vh] flex items-center overflow-hidden bg-coal">
        ...
        <div className="absolute inset-0 hidden md:block" style={{background: 'linear-gradient(to left, #111111 0%, #111111 8%, transparent 35%)'}} />
        ...
        <div className="absolute inset-0 hidden md:block" style={{background: 'linear-gradient(to bottom, #111111 0%, #111111 3%, transparent 25%)'}} />
        <div className="absolute inset-0 hidden md:block" style={{background: 'linear-gradient(to top, #111111 0%, #111111 3%, transparent 25%)'}} />
